...
public class PeerClient4 
{
	...
	private static String nodeId = "1004";
	...
	public PeerClient4(ServerSocket serverSocket)
	{
		...
		try
		{
			...
			{	
				...
				{	
					...
					PeerClient4.pool.execute(peerClient);
				}
	...
	{
		routingInfo.put("8001", "134.226.58.160");
		routingInfo.put("8002", "134.226.58.160");
		routingInfo.put("8003", "134.226.58.160");
		routingInfo.put("8004", "134.226.58.160");
	}
	...
	public class PeerClient implements Runnable
	{
		...
		private PeerClient4 peerModule;
		private int clientId;
		private boolean kill;
	
		PeerClient(Socket socket,PeerClient4 peerModule,int clientId)
		{
			this.socket=socket;
	...
	{
		static PeerClient4 thisPeerClient4;
				
		ThisPeer(PeerClient4 peerModule)
		{
			this.thisPeerClient4 = peerModule;
		}
		...
		{
			thisPeerClient4.sendMessage(node, ipAddress, port, jsonObj);
		}
		private void chat(JSONObject jsonObj) 
		{
			thisPeerClient4.chat(jsonObj);
	...
	{	
		//This node
		PeerClient4 pm = new PeerClient4(new ServerSocket(5555));	
