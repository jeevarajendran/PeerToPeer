...
public class PeerClient2 
{
	...
	public PeerClient2(ServerSocket serverSocket)
	{
		...
		try
		{
			...
			{	
				...
				{	
					...
					PeerClient2.pool.execute(peerClient);
				}
	...
	private void initializeRoutingTable() 
	{
		...
		routingInfo.put("2003", "134.226.58.160");
		routingInfo.put("2004", "134.226.58.160");
		routingInfo.put("2005", "134.226.58.160");
	}
	...
	public void chat(JSONObject jsonInput)
	{
		...
		else
		{
			...
			else
			{
				...
				if(!closestNode.equals(nodeId))
				{
					sendMessage(closestNode,closestIp,8767,jsonInput);
				}
				else
				{
					System.out.println("I DONT HAVE ANY OTHER CLOSER NODE TO THE TARGET . DONE!!!!");
	...
	public class PeerClient implements Runnable
	{
		...
		private PeerClient2 peerModule;
		private int clientId;
		private boolean kill;
	
		PeerClient(Socket socket,PeerClient2 peerModule,int clientId)
		{
			this.socket=socket;
	...
	{
		static PeerClient2 thisPeerClient2;
				
		ThisPeer(PeerClient2 peerModule)
		{
			this.thisPeerClient2 = peerModule;
		}
		...
		{
			thisPeerClient2.sendMessage(node, ipAddress, port, jsonObj);
		}
		private void chat(JSONObject jsonObj) 
		{
			thisPeerClient2.chat(jsonObj);
	...
	{	
		//This node
		PeerClient2 pm = new PeerClient2(new ServerSocket(7777));	
